...
SUDO = SUDO
sudo_users = {SUDO,962203100,1271545929,1740602430}   
print([[
...
~> DEVELOPER › @SAAAA -sonic
]])
if io.open("library/redis.lua","r") then
io.close(io.open("library/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd library && wget https://raw.githubusercontent.com/afnan505/Afnan/master/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/saaaa/Files_Afnan/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAfnanW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "saaaa")
...
local Afnan_Msg = ''  
if msgs < 100 then 
Afnan_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Afnan_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Afnan_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Afnan_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Afnan_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Afnan_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Afnan_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Afnan_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Afnan_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Afnan_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Afnan_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Afnan_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Afnan_Msg = 'التفاعل نفسو'  
end 
return Afnan_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@KKKKK4")  
...
--------------------------------------------------------------------------------------------------------------
function SourceAfnan(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Afnan1:List:Filter"..sl)
...
if not DevAfnanW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevAfnanW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Afnan_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل -' and DevAfnanW(msg) then  
...
if text == 'تعطيل التواصل -' and DevAfnanW(msg) then  
...
if text == 'تفعيل البوت الخدمي -' and DevAfnanW(msg) then  
...
if text == 'تعطيل البوت الخدمي -' and DevAfnanW(msg) then  
...
if text == 'ضع كليشه ستارت -' and DevAfnanW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *٭ ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت -' and DevAfnanW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *٭ تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر -' and DevAfnanW(msg) then 
...
if text == 'الاصدار -' and DevAfnanW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *٭ اصدار سورس Afnan* \n*٭ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت -' and DevAfnanW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ٭ [تحديثات البوت](t.me/saaaa) \n٭ [قناه السورس](t.me/saaaa)')
end
if text == "ضع اسم للبوت -" and DevAfnanW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *٭ ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات -' and DevAfnanW(msg) then 
...
if text == 'المشتركين -' and DevAfnanW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *٭ المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات -' and DevAfnanW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *٭ الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين -") and DevAfnanW(msg) then
...
if text == ("قائمه العام -") and DevAfnanW(msg) then
...
if text == ("قائمه الكتم العام -") and DevAfnanW(msg) then
...
if text=="اذاعه خاص -" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه -" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت -" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه -" and msg.reply_to_message_id_ == 0  and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص -" and msg.reply_to_message_id_ == 0  and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ٭ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه -' and DevAfnanW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين -" and DevAfnanW(msg) then
...
if text == "تنظيف الجروبات -" and DevAfnanW(msg) then 
...
send(msg.chat_id_, msg.id_,'*٭ عدد الجروبات الان » { '..#group..' }'..Afnank..''..Afnan..'*\n*٭ الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevAfnanW(msg) then
...
usertext = '*\n ٭ اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'saaaa')..')'
status  = '\n *٭ تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevAfnanW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *٭ اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
status  = '\n*٭ تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAfnanW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevAfnanW(msg) then
...
local Afnan1_Msg = database:get(bot_id.."Afnan1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Afnan1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *٭ اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'saaaa')..') \n ٭ '..Afnan1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Afnan_Msg and not Special(msg) then  
local Afnan_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Afnan_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *٭ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n٭ ["..Afnan_Msg.."] \n")
else
send(msg.chat_id_,0," *٭ العضو :* {["..data.first_name_.."](T.ME/saaaa)}\n٭ ["..Afnan_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *٭ عذرا ↫* {["..data.first_name_.."](T.ME/saaaa)}\n*٭ عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevAfnanW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevAfnanW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevAfnanW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *٭ حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك -" and DevAfnanW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *٭ تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك -$") and DevAfnanW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *٭ حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري -" and DevAfnanW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري -" and DevAfnanW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *٭ تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري -" and DevAfnanW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Afnan:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Afnan:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Afnan = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Afnan then 
names_Afnan = database:smembers(bot_id.."Afnan:blocname"..msg.chat_id_) or ""
if names_Afnan and names_Afnan[1] then 
for i=1,#names_Afnan do 
if name_Afnan:match("(.*)("..names_Afnan[i]..")(.*)") then 
...
database:set(bot_id.."Afnan:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Afnan:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Afnan:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Afnan:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Afnan:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Afnana_new(Afnan1,Afnan2)
if Afnan2 and Afnan2.first_name_ then 
if Afnan2.first_name_:match("(.*)"..database:get(bot_id.."Afnan:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Afnan:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Afnan_nnn = database:get(bot_id.."Afnan:nump"..msg.chat_id_) or 5
local Afnan_nnn2 = database:get(bot_id.."Afnan:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Afnan_nnn2) == tonumber(Afnan_nnn) or tonumber(Afnan_nnn2) > tonumber(Afnan_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Afnan:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "٭ عزيزي >>["..Afnan2.username_.."](https://t.me/"..(Afnan2.username_ or "saaaa")..")\n٭ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Afnan:teh"..msg.chat_id_).."} بجانب اسمك\n٭ عدد المحاولات المتبقيه {"..(tonumber(Afnan_nnn) - tonumber(Afnan_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Afnana_new)
end
end
...
local AfnanChengName = database:get(bot_id.."Afnan:Cheng:Name"..data.id_)
if not data.first_name_ then 
if AfnanChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..AfnanChengName..']')
database:del(bot_id.."Afnan:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if AfnanChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Afnan:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local AfnanChengUserName = database:get(bot_id.."Afnan:Cheng:UserName"..data.id_)
if not data.username_ then 
if AfnanChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..AfnanChengUserName..']')
database:del(bot_id.."Afnan:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if AfnanChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Afnan:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local AfnanChengPhoto = database:get(bot_id.."Afnan:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if AfnanChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Afnan:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if AfnanChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Afnan:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevAfnanW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*٭ بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'saaaa')..') \n*٭ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *٭ بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'saaaa')..') \n*٭ تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevAfnanW(msg) then
dofile('BoykA.lua')  
send(msg.chat_id_, msg.id_, ' *٭ تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevAfnanW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevAfnanW(msg) then  
function start_function(extra, result, success)
if AfnanSudoBot(result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *٭ لا يمكنك حظر او كتم او طرد مطور السورس*")
return false 
end
...
if text and text:match("^حظر عام @(.*)$")  and DevAfnanW(msg) then  
...
if AfnanSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*٭ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevAfnanW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if AfnanSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*٭ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevAfnanW(msg) then  
function start_function(extra, result, success)
if AfnanSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*٭ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevAfnanW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevAfnanW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if AfnanSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*٭ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevAfnanW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevAfnanW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevAfnanW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevAfnanW(msg) then
...
if text == 'الملفات' and DevAfnanW(msg) then
t = ' *٭ ملفات السورس Afnan↓*\n*•━━━━━━  ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevAfnanW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Afnan-DeV/Files_Afnan/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *٭ اهلا بك في متجر ملفات Afnan*\n*٭ ملفات السورس ↓*\n*•━━━━━━  ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━  ━━━━━━━•*\n *٭ علامة تعني { ✓ } ملف مفعل*\n *٭ علامة تعني { ✘ } ملف معطل*\n *٭ قناة سورس Afnan↓*\n".." *٭ *[اضغط هنا لدخول](t.me/saaaa) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevAfnanW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Afnan-DeV/Files_Afnan/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BoykA.lua')  
else
send(msg.chat_id_, msg.id_," *٭ عذرا الملف لايدعم سورس Afnan* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevAfnanW(msg) then
...
if text == "مسح الملفات" and DevAfnanW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *٭ تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevAfnanW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevAfnanW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "saaaa")
...
function Function_Afnan(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Afnan, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Afnan, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
status  = '\n*٭ تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *٭ لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
status  = '\n*٭ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *٭ اسم المستخدم »* '..userid..''
...
-----------------------------------------------------
if text == 'تنزيل الشراميط' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *٭ تم مسح جميع للشراميط*')
end
if text == ("تاك للشراميط") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n *٭ قائمه حاتات للشراميط* \n*•━━━━━━  ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الشرموطه [@"..username.."]\n"
else
t = t..""..k.."» الشرموطه `"..v.."`\n"
end
end
if #list == 0 then
t = " *٭ مع الاسف لا يوجد شراميط*"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع شرموطه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *٭ تم تعطيل الرفع*') 
return false
end
...
local  statuss  = '\n*٭ تم رفع العضــو الشرموطه في الجروب* \n*٭ تعالي نعمل واحد يكسمك*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل شرموطه")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
status  = '\n*٭ تم تنزيل العضــو الشرموطه من الجروب*\n*٭ بكره تجيلي ملط وانا اقولك بطلت*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if #list == 0 then
t = " *٭ مع الاسف لا يوجد متناكين*"
end
send(msg.chat_id_, msg.id_, t)
end
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("رفع متناك") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *٭ تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*٭ تم رفع العضــو متناك في الجروب* \n*٭  تعال انيكك يعرص*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل متناك")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Modde:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
status  = '\n*٭ تم تنزيل العضــو متناك في الجروب*\n*٭  يلا هنجيب متناك غيرك*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تنزيل كس' and Mod(msg) then
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *٭ تم تنزيل جميع الاكساس*')
end
if text == ("تاك للكساس") and Mod(msg) then
...
---------
if text == ("رفع كس") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *٭ تم تعطيل الرفع*') 
return false
end
...
if (text == ("تنزيل كس")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
...
if text == ("زواج") and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
...
database:set(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *٭ ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Afnan1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Afnan1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *٭ تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Afnan1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Afnan1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Afnan1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *٭ ارسل الكلمه الان*")  
database:set(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Afnan1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Afnan1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Afnan1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Afnan1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Afnan1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Afnan1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevAfnanW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *٭ تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevAfnanW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *٭ اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'saaaa')..')'..'\n*٭ تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevAfnanW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevAfnanW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Afnan_Msg[math.random(#Afnan_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevAfnanW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Afnan)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━  ━━━━━━━•*\n"
x = 0
local list = Afnan.members_
for k, v in pairs(list) do
x = x + 1
...
if AfnanSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevAfnanW(msg) then 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/nsjsiwj/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'اضف رد للكل' and DevAfnanW(msg) then    
send(msg.chat_id_, msg.id_,' *٭ ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevAfnanW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'Afnan').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevAfnanW(msg) then   
...
if text == 'تعطيل المغادره' and DevAfnanW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'saaaa')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Afnandx(msg.chat_id_, msg.id_, ' *٭ ايدي المجموعة » ( '..msg.chat_id_..' )*\n*٭ عدد الادمنيه » ( '..data.administrator_count_..' )*\n*٭ عدد المحظورين » ( '..data.kicked_count_..' )*\n*٭ عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevAfnanW(msg) then
...
zh = https.request('https://Afnan-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*٭ قائمه الزخرفه* \nٴ-∫ٴ*•━━━━━━  ━━━━━━━•*ٴ-∫○ٴ \n"
i = 0
...
gk = https.request('https://Afnan-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://Afnan-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://Afnan-api.ml/audios.php')
if res == 200 then
...
vardump(data)
if DAata and DAata:match('@id/(.*)') then
local Id_Link = DAata:match('@id/(.*)') 
tdcli_function ({ID = "GetUser",user_id_ = bot_id,},function(arg,data) 
DeleteMessage(Chat_id,{[0] = Msg_id})  
...
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ⁦',url='http://t.me/saaaa'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'Afnan')
...
Afnan = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Afnan)
...
--------------------------------------------------------------------------------------------------------------
SourceAfnan(data.message_,data)
...
------------------------------------------------------------------------
local revorb0t = database:get(bot_id.."Afnan1:Add:Filter:Rp2"..text..result.chat_id_)   
if revorb0t then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *٭ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n٭ ["..revorb0t.."] \n") 
...
------------------------------------------------------------------------
if text then
local Afnan1_Msg = database:get(bot_id.."Afnan1:Add:Filter:Rp2"..text..result.chat_id_)   
if Afnan1_Msg then
send(msg.chat_id_, msg.id_," ٭ "..Afnan1_Msg)
